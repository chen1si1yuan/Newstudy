...
public class Entity implements org.apache.thrift.TBase<Entity, Entity._Fields>, java.io.Serializable, Cloneable, Comparable<Entity> {
  ...
  private static final org.apache.thrift.protocol.TField PHRASE_FIELD_DESC = new org.apache.thrift.protocol.TField("phrase", org.apache.thrift.protocol.TType.STRING, (short)2);
  ...
  public String phrase; // optional
  public String value; // optional

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    KEY((short)1, "key"),
    PHRASE((short)2, "phrase"),
    VALUE((short)3, "value");
  ...
  private static final _Fields optionals[] = {_Fields.KEY,_Fields.PHRASE,_Fields.VALUE};
  ...
  static {
    ...
    tmpMap.put(_Fields.PHRASE, new org.apache.thrift.meta_data.FieldMetaData("phrase", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
  ...
  public Entity setPhrase(String phrase) {
    this.phrase = phrase;
    return this;
  }
  ...
  /** Returns true if field phrase is set (has been assigned a value) and false otherwise */
  public boolean isSetPhrase() {
    return this.phrase != null;
  }

  public void setPhraseIsSet(boolean value) {
    if (!value) {
      this.phrase = null;
    }
  }
  ...
  public boolean equals(Entity that) {
    ...
    boolean this_present_phrase = true && this.isSetPhrase();
    boolean that_present_phrase = true && that.isSetPhrase();
    if (this_present_phrase || that_present_phrase) {
      if (!(this_present_phrase && that_present_phrase))
        return false;
      if (!this.phrase.equals(that.phrase))
        return false;
    }
  ...
  public int compareTo(Entity other) {
    ...
    lastComparison = Boolean.valueOf(isSetPhrase()).compareTo(other.isSetPhrase());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPhrase()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.phrase, other.phrase);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class EntityStandardScheme extends StandardScheme<Entity> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, Entity struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 2: // PHRASE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              struct.phrase = iprot.readString();
              struct.setPhraseIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Entity struct) throws org.apache.thrift.TException {
      ...
      if (struct.phrase != null) {
        if (struct.isSetPhrase()) {
          oprot.writeFieldBegin(PHRASE_FIELD_DESC);
          oprot.writeString(struct.phrase);
          oprot.writeFieldEnd();
        }
      }
